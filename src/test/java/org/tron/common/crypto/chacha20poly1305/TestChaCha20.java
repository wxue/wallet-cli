...
public class TestChaCha20 {
    ...
    public void testIetfVector() {
        IntStream.range(0, IETF_KEY.length).parallel().forEach(l ->
                Assert.assertTrue(Arrays.equals(testImplementation(IETF_PLAIN[l], IETF_KEY[l], IETF_NONCE[l], IETF_COUNTER[l]),
                                         IETF_EXPECTED[l])));
    }
    ...
    public void testRandom1() {
        ...
        IntStream.of(len).parallel().forEach(l -> Assert.assertTrue(testRandomLen(l)));
    }
    ...
    public void testRandom2() {
        int[] len = {16, 32, 64, 128, 100, 200, 256, 300, 500, 512, 1024, 1048576, 100 * 1048576};
        IntStream.of(len).parallel().forEach(l -> Assert.assertTrue(testRandomBC(l)));
    }
    ...
    public void testBC1() {
        ...
        Assert.assertTrue(Arrays.equals(own, bc));
    }
