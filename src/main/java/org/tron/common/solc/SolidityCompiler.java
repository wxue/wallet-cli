...
//    @Autowired
    ...
    public static Result compile(File sourceDirectory, boolean enableOptimize, boolean combinedJson, Option... options) throws IOException {
        return getInstance().compileSrc(sourceDirectory, enableOptimize, combinedJson, options);
    }
    ...
    public static Result compile(byte[] source, boolean optimize, boolean combinedJson, Option... options) throws IOException {
