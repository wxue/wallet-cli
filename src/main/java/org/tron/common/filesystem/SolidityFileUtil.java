...
public class SolidityFileUtil {
    ...
    private static final Logger logger = LoggerFactory.getLogger(SolidityFileUtil.class);
    ...
    public static File getExistFile(String fileName) {
        ...
        if (!file.exists()){
            URL url = SolidityFileUtil.class.getClassLoader().getResource(PathUtil.combine(Config.LOCAL_SOURCE_PATH, fileName));
